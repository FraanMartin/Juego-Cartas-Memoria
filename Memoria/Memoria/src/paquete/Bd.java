...
public class Bd {
	...
	public void mostrarFacil(DefaultTableModel modelo) {
		Query = "USE Puntos;";
		Query = "SELECT * FROM FACIL LIMIT 4";
		try {
	...
	public void mostrarMedio(DefaultTableModel modelo) {
		Query = "USE Puntos;";
		Query = "SELECT * FROM MEDIO LIMIT 4";
		try {
	...
	public void mostrarMedioRecord(DefaultTableModel modelo) {
		Query = "USE Puntos;";
		Query = "SELECT MIN(puntos) AS Record FROM MEDIO";
		try {
	...
	public void mostrarDificil(DefaultTableModel modelo) {
		Query = "USE Puntos;";
		Query = "SELECT * FROM DIFICIL LIMIT 4";
		try {
	...
	public void mostrarDificilRecord(DefaultTableModel modelo) {
		Query = "USE Puntos;";
		Query = "SELECT MIN(puntos) AS Record FROM DIFICIL";
		try {
